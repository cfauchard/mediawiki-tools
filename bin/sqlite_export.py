...
parser = argparse.ArgumentParser(description='export Mediawiki pages in directory structure')
...
try:
    ...
    for page_row in conn.execute('SELECT page_id, page_title FROM page ORDER BY page_title'):
        page_id = page_row[0]
